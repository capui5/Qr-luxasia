		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "New Profile",
									"targetURL": "#comnewcustqrnewcustqr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnewcustqrnewcustqr-display": {
								"semanticObject": "comnewcustqrnewcustqr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.newcustqr.newcustqr",
									"url": sap.ui.require.toUrl("com/newcustqr/newcustqr")
								}
							}
						}
					}
